...
<body>
    <div class="container" style="margin-top:20px;max-width: 1250px;">
        <a href="/" class="<?= $c == 'employee' ? 'active' : '' ?> btn btn-info">Employee</a>
        <a href="?c=department" class="<?= $c == 'department' ? 'active' : '' ?> btn btn-info">Department</a>
        <?php
        $message = '';
